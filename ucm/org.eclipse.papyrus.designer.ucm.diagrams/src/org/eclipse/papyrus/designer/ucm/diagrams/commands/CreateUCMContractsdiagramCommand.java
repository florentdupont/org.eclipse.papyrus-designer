...
/**
 * Create a UCM non-functional aspects diagram command
 */
public class CreateUCMContractsdiagramCommand extends CreateClassDiagramCommand {

	/**
	 * UCM Composite diagram type.
	 */
	public static final String DIAGRAM_TYPE = "UCMContractsDiagram"; //$NON-NLS-1$
