...
/**
 * Edit Helper Advice for {@link AssemblyPart}
 */
public class AssemblyPartEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	protected ICommand getAfterConfigureCommand(ConfigureRequest request) {
		CompositeCommand compositeCommand = new CompositeCommand("Assembly part configuration command");
		...
		IStaticContentProvider cp = new UCMContentProvider(
				PackageUtil.getRootPackage((Element) newElement), UMLPackage.eINSTANCE.getClass_(), IComponent.class);
		
		EnhancedPopupMenu popupMenu = MenuHelper.createPopupMenu(cp, "Choose part type", false);
