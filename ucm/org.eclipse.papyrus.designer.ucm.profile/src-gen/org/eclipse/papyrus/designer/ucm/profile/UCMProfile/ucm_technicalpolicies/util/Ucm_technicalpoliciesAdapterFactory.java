...
public class Ucm_technicalpoliciesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Ucm_technicalpoliciesSwitch<Adapter> modelSwitch =
		new Ucm_technicalpoliciesSwitch<Adapter>() {
			@Override
			public Adapter caseTechnicalAspect(TechnicalAspect object) {
				return createTechnicalAspectAdapter();
			}
			@Override
			public Adapter caseProgrammingLanguages(ProgrammingLanguages object) {
				return createProgrammingLanguagesAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseNonfunctionalAspectModule(NonfunctionalAspectModule object) {
				return createNonfunctionalAspectModuleAdapter();
			}
			@Override
			public Adapter caseTechnicalPolicyDefinition(TechnicalPolicyDefinition object) {
				return createTechnicalPolicyDefinitionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.TechnicalAspect <em>Technical Aspect</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.ProgrammingLanguages <em>Programming Languages</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.Language <em>Language</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.NonfunctionalAspectModule <em>Nonfunctional Aspect Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.TechnicalPolicyDefinition <em>Technical Policy Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //Ucm_technicalpoliciesAdapterFactory
