 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.languages.java.profile.PapyrusJava.impl.DefaultImpl#getBase_Operation <em>Base Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultImpl extends MinimalEObjectImpl.Container implements Default {
		...
		if (base_Operation != null && base_Operation.eIsProxy()) {
			...
			if (base_Operation != oldBase_Operation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PapyrusJavaPackage.DEFAULT__BASE_OPERATION, oldBase_Operation, base_Operation));
			}
		}
	...
	public void setBase_Operation(Operation newBase_Operation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PapyrusJavaPackage.DEFAULT__BASE_OPERATION, oldBase_Operation, base_Operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PapyrusJavaPackage.DEFAULT__BASE_OPERATION:
