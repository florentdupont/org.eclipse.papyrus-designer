...
/**
 * Edit Helper Advice for Language
 */
public class LanguageEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	protected boolean approveCreateElementRequest(CreateElementRequest request) {
		...
		if (type != null && container instanceof Package) {
			if (UMLUtil.getStereotypeApplication((Package) container, ProgrammingLanguages.class) != null) {
				return true;
			}
		}
		return false;
