...
public class Ucm_extra_typesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Ucm_extra_typesPackage.DATA_POINTER: {
				DataPointer dataPointer = (DataPointer)theEObject;
				T result = caseDataPointer(dataPointer);
				if (result == null) result = caseIDataType(dataPointer);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Pointer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Pointer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataPointer(DataPointer object) {
		return null;
	}
