 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.languages.common.profile.Codegen.impl.LanguageImpl#getBase_Class <em>Base Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LanguageImpl extends MinimalEObjectImpl.Container implements Language {
	...
	protected EClass eStaticClass() {
		return CodegenPackage.Literals.LANGUAGE;
	}
		...
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CodegenPackage.LANGUAGE__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodegenPackage.LANGUAGE__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodegenPackage.LANGUAGE__BASE_CLASS:
