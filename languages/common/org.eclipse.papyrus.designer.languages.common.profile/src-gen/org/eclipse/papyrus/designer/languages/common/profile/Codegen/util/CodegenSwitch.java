...
public class CodegenSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CodegenPackage.GENERATOR_HINT: {
				GeneratorHint generatorHint = (GeneratorHint)theEObject;
				T result = caseGeneratorHint(generatorHint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodegenPackage.LANGUAGE: {
				Language language = (Language)theEObject;
				T result = caseLanguage(language);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodegenPackage.NO_CODE_GEN: {
			...
			case CodegenPackage.ARCHE_TYPE: {
				ArcheType archeType = (ArcheType)theEObject;
				T result = caseArcheType(archeType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodegenPackage.MAVEN_DEPENDENCY: {
				MavenDependency mavenDependency = (MavenDependency)theEObject;
				T result = caseMavenDependency(mavenDependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodegenPackage.EXCLUDED_DEPENDENCY: {
				ExcludedDependency excludedDependency = (ExcludedDependency)theEObject;
				T result = caseExcludedDependency(excludedDependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodegenPackage.PARENT_ARTIFACT: {
				ParentArtifact parentArtifact = (ParentArtifact)theEObject;
				T result = caseParentArtifact(parentArtifact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generator Hint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generator Hint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGeneratorHint(GeneratorHint object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arche Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arche Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Excluded Dependency</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Excluded Dependency</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExcludedDependency(ExcludedDependency object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parent Artifact</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parent Artifact</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParentArtifact(ParentArtifact object) {
		return null;
	}
