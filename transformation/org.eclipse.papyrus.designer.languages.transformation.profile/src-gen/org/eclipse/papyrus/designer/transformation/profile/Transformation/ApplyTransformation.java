...
public interface ApplyTransformation extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Trafo</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Trafo</em>' reference.
	 * @see #setTrafo(M2MTrafo)
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.designer.transformation.profile.Transformation.ApplyTransformation#getTrafo <em>Trafo</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Trafo</em>' reference.
	 * @see #getTrafo()
	 * @generated
	 */
	void setTrafo(M2MTrafo value);
