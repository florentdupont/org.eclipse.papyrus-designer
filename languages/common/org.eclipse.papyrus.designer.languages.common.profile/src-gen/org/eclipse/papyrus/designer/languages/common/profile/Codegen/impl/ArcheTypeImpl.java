 ...
 *   <li>{@link org.eclipse.papyrus.designer.languages.common.profile.Codegen.impl.ArcheTypeImpl#getReprository <em>Reprository</em>}</li>
...
public class ArcheTypeImpl extends MinimalEObjectImpl.Container implements ArcheType {
	...
	/**
	 * The default value of the '{@link #getReprository() <em>Reprository</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReprository()
	 * @generated
	 * @ordered
	 */
	protected static final String REPROSITORY_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getReprository() <em>Reprository</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReprository()
	 * @generated
	 * @ordered
	 */
	protected String reprository = REPROSITORY_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setReprository(String newReprository) {
		String oldReprository = reprository;
		reprository = newReprository;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodegenPackage.ARCHE_TYPE__REPROSITORY, oldReprository, reprository));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CodegenPackage.ARCHE_TYPE__VERSION:
				return getVersion();
			case CodegenPackage.ARCHE_TYPE__REPROSITORY:
				return getReprository();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CodegenPackage.ARCHE_TYPE__VERSION:
				...
				return;
			case CodegenPackage.ARCHE_TYPE__REPROSITORY:
				setReprository((String)newValue);
				return;
			case CodegenPackage.ARCHE_TYPE__BASE_CLASS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case CodegenPackage.ARCHE_TYPE__VERSION:
				...
				return;
			case CodegenPackage.ARCHE_TYPE__REPROSITORY:
				setReprository(REPROSITORY_EDEFAULT);
				return;
			case CodegenPackage.ARCHE_TYPE__BASE_CLASS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CodegenPackage.ARCHE_TYPE__REPROSITORY:
				return REPROSITORY_EDEFAULT == null ? reprository != null : !REPROSITORY_EDEFAULT.equals(reprository);
			case CodegenPackage.ARCHE_TYPE__BASE_CLASS:
