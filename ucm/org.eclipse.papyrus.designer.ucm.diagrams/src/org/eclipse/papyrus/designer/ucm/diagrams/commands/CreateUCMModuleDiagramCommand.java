...
/**
 * Create UCM module diagram command
 */
public class CreateUCMModuleDiagramCommand extends CreateClassDiagramCommand {

	/**
	 * UCM mmodule diagram type.
	 */
	public static final String DIAGRAM_TYPE = "UCMModuleDiagram"; //$NON-NLS-1$
