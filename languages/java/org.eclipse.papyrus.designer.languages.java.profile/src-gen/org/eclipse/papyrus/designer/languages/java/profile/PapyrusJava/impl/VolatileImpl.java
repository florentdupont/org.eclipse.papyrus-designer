 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.languages.java.profile.PapyrusJava.impl.VolatileImpl#getBase_Property <em>Base Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VolatileImpl extends MinimalEObjectImpl.Container implements Volatile {
		...
		if (base_Property != null && base_Property.eIsProxy()) {
			...
			if (base_Property != oldBase_Property) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PapyrusJavaPackage.VOLATILE__BASE_PROPERTY, oldBase_Property, base_Property));
			}
		}
	...
	public void setBase_Property(Property newBase_Property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PapyrusJavaPackage.VOLATILE__BASE_PROPERTY, oldBase_Property, base_Property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PapyrusJavaPackage.VOLATILE__BASE_PROPERTY:
