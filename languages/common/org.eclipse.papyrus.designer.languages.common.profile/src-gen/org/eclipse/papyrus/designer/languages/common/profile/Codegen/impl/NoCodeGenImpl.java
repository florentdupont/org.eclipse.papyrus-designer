 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.languages.common.profile.Codegen.impl.NoCodeGenImpl#getBase_Element <em>Base Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NoCodeGenImpl extends MinimalEObjectImpl.Container implements NoCodeGen {
	...
	protected EClass eStaticClass() {
		return CodegenPackage.Literals.NO_CODE_GEN;
	}
		...
		if (base_Element != null && base_Element.eIsProxy()) {
			...
			if (base_Element != oldBase_Element) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CodegenPackage.NO_CODE_GEN__BASE_ELEMENT, oldBase_Element, base_Element));
			}
		}
		return base_Element;
	}
	...
	public void setBase_Element(Element newBase_Element) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodegenPackage.NO_CODE_GEN__BASE_ELEMENT, oldBase_Element, base_Element));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodegenPackage.NO_CODE_GEN__BASE_ELEMENT:
