...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Primitive Char</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.ucm.types.profile.UCMTypes.Types.impl.PrimitiveCharImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveCharImpl extends IStandardDataTypeImpl implements PrimitiveChar {
	 ...
	 * @generated
	 */
	public void setKind(PrimitiveCharKind newKind) {
		PrimitiveCharKind oldKind = kind;
		kind = newKind == null ? KIND_EDEFAULT : newKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PRIMITIVE_CHAR__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.PRIMITIVE_CHAR__KIND:
				return getKind();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TypesPackage.PRIMITIVE_CHAR__KIND:
				setKind((PrimitiveCharKind)newValue);
				return;
		}
