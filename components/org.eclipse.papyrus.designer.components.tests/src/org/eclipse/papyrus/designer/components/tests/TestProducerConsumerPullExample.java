...
public class TestProducerConsumerPullExample {

	@SuppressWarnings("nls")
	public static final String PRODUCER_CONSUMER_MONO_NODE_MONO_PULL = "ProducerConsumer_monoNode_monoPull";

	@SuppressWarnings("nls")
	public static final String DEPLOYMENT_MONO_PULL = "ProducerConsumer::deployment::monoPull";
	...
	public void testProducerConsumerMonoPull() throws InterruptedException {
		...
		IProject genProject = houseKeeper.createProject(PRODUCER_CONSUMER_MONO_NODE_MONO_PULL);
		...
		tts.validateResults(genProject, TestConstants.EXPECTED_RESULT + TestConstants.FILE_SEP +
				PRODUCER_CONSUMER_MONO_NODE_MONO_PULL + TestConstants.FILE_SEP + TestConstants.SRC_GEN, TestConstants.SRC_GEN);
	}
