...
package org.eclipse.papyrus.designer.languages.java.codegen.ui.preferences;
...
public class CodegenPreferencePage extends FieldEditorPreferencePage implements
	...
	public CodegenPreferencePage() {
		...
		setDescription("This preferences page allows to customize Papyrus Java code generation");
	}
	...
	public void createFieldEditors() {
		...
		addField(new StringFieldEditor(JavaCodeGenConstants.P_JAVA_SUFFIX,
				"Suffix for Java files ", getFieldEditorParent()));
		addField(new StringFieldEditor(JavaCodeGenConstants.P_PROJECT_PREFIX,
				"Prefix for generated Java (JDT) projects ", getFieldEditorParent()));

		// Add P_COMMENT_HEADER
		addTextField(JavaCodeGenConstants.P_COMMENT_HEADER, "Header for generated files",
				pCommentDoc);
	}
	...
	public void performDefaults() {
		...
		pCommentDoc.set(getPreferenceStore().getDefaultString(JavaCodeGenConstants.P_COMMENT_HEADER));
	...
	public boolean performOk() {
		...
		getPreferenceStore().setValue(JavaCodeGenConstants.P_COMMENT_HEADER, currentComment);
