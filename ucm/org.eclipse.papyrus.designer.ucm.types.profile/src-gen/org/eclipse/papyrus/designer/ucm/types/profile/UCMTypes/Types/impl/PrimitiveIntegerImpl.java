 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.designer.ucm.types.profile.UCMTypes.Types.impl.PrimitiveIntegerImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveIntegerImpl extends IStandardDataTypeImpl implements PrimitiveInteger {
	 ...
	 * @generated
	 */
	public void setKind(PrimitiveIntegerKind newKind) {
		PrimitiveIntegerKind oldKind = kind;
		kind = newKind == null ? KIND_EDEFAULT : newKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PRIMITIVE_INTEGER__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.PRIMITIVE_INTEGER__KIND:
				return getKind();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TypesPackage.PRIMITIVE_INTEGER__KIND:
				setKind((PrimitiveIntegerKind)newValue);
				return;
		}
