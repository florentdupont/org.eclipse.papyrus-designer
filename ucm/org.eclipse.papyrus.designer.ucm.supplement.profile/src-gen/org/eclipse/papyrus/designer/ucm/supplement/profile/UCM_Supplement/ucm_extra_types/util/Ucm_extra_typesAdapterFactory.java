...
public class Ucm_extra_typesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Ucm_extra_typesSwitch<Adapter> modelSwitch =
		new Ucm_extra_typesSwitch<Adapter>() {
			@Override
			public Adapter caseDataPointer(DataPointer object) {
				return createDataPointerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.designer.ucm.supplement.profile.UCM_Supplement.ucm_extra_types.DataPointer <em>Data Pointer</em>}'.
	 * <!-- begin-user-doc -->
