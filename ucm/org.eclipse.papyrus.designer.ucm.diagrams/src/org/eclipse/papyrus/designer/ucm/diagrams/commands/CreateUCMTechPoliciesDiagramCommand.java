 ...
 */
public class CreateUCMTechPoliciesDiagramCommand extends CreateClassDiagramCommand {

	/**
	 * UCM technical policies diagram type.
	 */
	public static final String DIAGRAM_TYPE = "UCMTechPoliciesDiagram"; //$NON-NLS-1$
