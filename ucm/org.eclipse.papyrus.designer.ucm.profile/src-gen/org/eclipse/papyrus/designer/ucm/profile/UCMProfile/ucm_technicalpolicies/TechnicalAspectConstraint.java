...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Technical Aspect Constraint</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.papyrus.designer.ucm.profile.UCMProfile.ucm_technicalpolicies.Ucm_technicalpoliciesPackage#getTechnicalAspectConstraint()
 * @model
 * @generated
 */
public enum TechnicalAspectConstraint implements Enumerator {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>ANY NUMBER</b></em>' literal object isn't clear,
	...
	/**
	 * An array of all the '<em><b>Technical Aspect Constraint</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TechnicalAspectConstraint[] VALUES_ARRAY =
		new TechnicalAspectConstraint[] {
			ANY_NUMBER,
			AT_MOST_ONE,
			EXACTLY_ONE,
			AT_LEAST_ONE,
	...
	/**
	 * A public read-only list of all the '<em><b>Technical Aspect Constraint</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TechnicalAspectConstraint> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Technical Aspect Constraint</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Technical Aspect Constraint</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Technical Aspect Constraint</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static TechnicalAspectConstraint get(int value) {
		switch (value) {
			case ANY_NUMBER_VALUE: return ANY_NUMBER;
