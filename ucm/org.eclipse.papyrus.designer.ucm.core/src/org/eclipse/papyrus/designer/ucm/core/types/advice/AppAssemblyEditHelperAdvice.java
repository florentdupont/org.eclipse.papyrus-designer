...
/**
 * Edit Helper Advice for {@link AppAssembly}
 */
public class AppAssemblyEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	protected boolean approveCreateElementRequest(CreateElementRequest request) {
		...
		if (type != null && container instanceof Package) {
			if (UMLUtil.getStereotypeApplication((Package) container, DeploymentModule.class) != null) {
				return true;
			}
		}
		return false;
