...
public class QualifiedNamesFromIJavaElementCollector {
	 ...
	 * @param includeCU
	 */
	protected QualifiedNamesFromIJavaElementCollector() {
		this(true, true);
	}
	 ...
	 * @param includeCU
	 */
	protected QualifiedNamesFromIJavaElementCollector(boolean includePackages, boolean includeCU) {
		super();
	 ...
	 * @return
	 */
	static public List<String> collectQualifiedNamesFromSelection( ISelection selection) {
